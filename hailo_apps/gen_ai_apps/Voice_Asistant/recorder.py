"""
Module: recorder
Handles microphone recording, audio processing, and saving for debugging.
"""
...
class Recorder:
    ...
    speech-to-text model (float32 mono 16kHz little-endian) and can save
    recordings for debugging purposes.
    """
