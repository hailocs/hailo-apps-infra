...
VALID_HAILORT_VERSION = [AUTO_DETECT, "4.20.0", "4.21.0", "4.22.0" , "5.0.0" , "5.0.1"]
VALID_TAPPAS_VERSION = [AUTO_DETECT, "3.30.0", "3.31.0", "3.32.0", "5.0.0" , "5.0.1"]
VALID_MODEL_ZOO_VERSION = ["v2.13.0", "v2.14.0", "v2.15.0" , "v2.16.0", "v5.0.0" , "v5.0.1"]
...
MODEL_ZOO_VERSION_DEFAULT = "v2.16.0"
...
LPR_LICENSE_DET_HEF_NAME = "yolov8n_relu6_license_plate"
...
LPR_OCR_POSTPROCESS_SO_FILENAME = "libocr_postprocess.so"
LPR_OCR_POSTPROCESS_FUNCTION = "paddleocr_recognize"
