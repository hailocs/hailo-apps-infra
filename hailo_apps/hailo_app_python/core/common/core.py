...
from .hailo_logger import _LEVELS, get_logger
...
def get_default_parser():
    ...
    parser.add_argument("--disable-callback", action="store_true", help="Disables the user's custom callback...")
...
def get_resource_path(pipeline_name: str, resource_type: str, model: str = None) -> Path | None:
    hailo_logger.debug(f"Getting resource path for pipeline={pipeline_name}, resource_type={resource_type}, model={model}")
