...
def download_resources(group: str = None, resource_config_path: str = None, arch: str = None):
    hailo_logger.debug(f"Starting download_resources with group={group}, config={resource_config_path}, arch={arch}")
...
def main():
    ...
    parser.add_argument("--config", type=str, default=DEFAULT_RESOURCES_CONFIG_PATH, help="Path to config file")
