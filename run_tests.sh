...
python -m hailo_apps.installation.download_resources --group all

python -m hailo_apps.installation.download_resources --arch hailo8l --group all # this download to test hailo8l models on hailo8
